locals {
  ...
  list_of_policies           = var.create_custom_policies ? concat(var.role_policy_arns, module.custom_policies[0].list_of_policy_arns) : var.role_policy_arns
}
...
resource "aws_iam_role" "this" {
  ...
  role_policy_arns   = local.list_of_policies
...
module "custom_policies" {
  count    = var.create_custom_policies && length(var.custom_policies) > 0 ? 1 : 0
  source   = "../iam-policy//."
